...
public class PriorithyManager implements ActionListener{
    private String name;
    private DefaultTableModel model;
    private JFrame j;
    private JTable table;
    private JButton btnAdd , btnRemove , btnModify;
    private ArrayList<Priority> tags = new ArrayList<>();


    
    public PriorithyManager(){
        ...
        String[] columnNames = {"Name", "color", "order"};
    ...
    public void Modify() {
        int selectedRow = table.getSelectedRow();
        if (selectedRow != -1) {
            Priority existing = tags.get(selectedRow);
