...
public class Column extends JPanel implements ActionListener,java.io.Serializable {
    ...
    public transient JLabel count_label,title_label;
    public transient JButton add_button;
    public transient JPanel body;
    ...
    public int columnAddTask(Task task){
        count++;
        task.setCard(CusColor.hexToColorObject(color.labelColor));
        task.setBorder(BorderFactory.createEmptyBorder(8, 8, 8, 8));
